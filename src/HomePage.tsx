    ...
    return (
        <div className="App">
            ...
            <div className="links" id="socialLinks">
                <a className="link" href="https://youtube.com/@DallinWebecke" target="_blank"><i
                    className="fa fa-youtube"/></a>
                <a className="link" href="https://instagram.com/dallin.from.earth" target="_blank"><i
                    className="fa fa-instagram"/></a>
                <a className="link" href="https://github.com/DallinFromEarth" target="_blank"><i
                    className="fa fa-github-square"/></a>
                <a className="link" href="https://www.linkedin.com/in/dallin-webecke/" target="_blank"><i
